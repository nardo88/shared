...
export const QuoteIcon: React.FC<IconProps> = (props): React.ReactNode => (
  <IconComponent {...props} viewBox="0 0 18 18" size={24}>
    <path d="M4.5 11.25H15.75" strokeWidth="1.3" strokeLinecap="round" strokeLinejoin="round" />
    <path d="M15.75 14.25H4.5" strokeWidth="1.3" strokeLinecap="round" strokeLinejoin="round" />
    <path d="M11.25 8.25H15.75" strokeWidth="1.3" strokeLinecap="round" strokeLinejoin="round" />
    <path d="M15.75 5.25H11.25" strokeWidth="1.3" strokeLinecap="round" strokeLinejoin="round" />
    <path
